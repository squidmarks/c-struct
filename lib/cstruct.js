...
unpacker.int32l = function (pointer, buffer) {
  pointer.offset += 4;
  return buffer.readInt32LE(pointer.offset - 4);
}

unpacker.doublel = function (pointer, buffer) {
  pointer.offset += 8;
  return buffer.readDoubleLE(pointer.offset - 8);
}
